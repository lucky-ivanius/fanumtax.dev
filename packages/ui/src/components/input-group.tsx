...
/** biome-ignore-all lint/a11y/useKeyWithClickEvents: ShadCn defaults for icons */
...
function InputGroupInput({ className, ...props }: React.ComponentProps<"input">) {
  return (
    <Input
      ...
      className={cn("flex-1 rounded-none border-0 bg-transparent shadow-none dark:bg-transparent", className)}
      {...props}
    />
  );
}

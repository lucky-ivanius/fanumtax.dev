/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 1034161b9e0b20379151836860abf406)
// Runtime types generated with workerd@1.20251008.0 2025-10-10 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		GITHUB_DEFAULT_ACCESS_TOKEN: string;
		HTTP_RPC_URL: string;
		D1: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JWT_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GITHUB_DEFAULT_ACCESS_TOKEN" | "HTTP_RPC_URL">> {}
}
